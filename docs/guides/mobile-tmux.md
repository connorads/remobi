...
See the [agent setup guide](agent-setup.md) for how to map your tmux bindings to remobi toolbar/drawer buttons automatically.
...
- [Agent setup](agent-setup.md) — configure remobi toolbar/drawer buttons with an AI agent
